...
import com.coding.helpers.tool.cmp.api.DefaultResponse;
...
public class ExceptionInterceptor {
    ...
    public AppResponse handle(Exception e) {
        AppResponse appResponse = new DefaultResponse();
        if (e instanceof AppException) {
            ...
            log.error(
                    String.format(
                            ...
                            AppStatus.SYSTEM_UNEXPECTED_ERROR_CODE,
                            AppStatus.SYSTEM_UNEXPECTED_ERROR_MESSAGE),
                    e);
            appResponse.setErrorCode(AppStatus.SYSTEM_UNEXPECTED_ERROR_CODE);
            appResponse.setErrorMessage(AppStatus.SYSTEM_UNEXPECTED_ERROR_MESSAGE);
        }
        return appResponse;
    }
}
