 ...
 * FTP模板.
 *
 * <p>创建时间: <font style="color:${symbol_pound}00FFFF">20180622 20:17</font><br>
 * [请在此输入功能详述]
 *
 * @author Rushing0711
 * @version 1.0.0
            ...
            if (success) {
                if (!StringUtils.isEmpty(remoteDirectory)) {
                    ...
                    if (!success) {
                        ...
                        success = true;
                        StringTokenizer token = new StringTokenizer(remoteDirectory, "${symbol_escape}${symbol_escape}//");
    ...
    public UploadResult uploadFile(ServerConfig serverConfig, UploadParam uploadParam)
        ...
        try {
            ...
            if (ftpClient != null) {
                ...
                // 如果这里不设置为null,finally会执行，且在GenericKeyedObjectPool${symbol_pound}returnObject方法中会抛出空指针异常
                ftpClient = null;
            }
        } finally {
            if (ftpClient != null) {
