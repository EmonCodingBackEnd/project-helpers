 ...
 * 正则表达式匹配解析类.
 *
 * <p>创建时间: <font style="color:${symbol_pound}00FFFF">20180424 15:10</font><br>
 * [请在此输入功能详述]
 *
 * @author Rushing0711
 * @version 1.0.0
...
public abstract class RegexSupport {
     ...
     * 示例1：完全匹配的正则表达式定义.
     *
     * <p>创建时间: <font style="color:${symbol_pound}00FFFF">20180424 15:06</font><br>
     * [请在此输入功能详述]
     *
     * @param value - 引用变量
     ...
     * @since 1.0.0
     */
    public static RegexResult match${symbol_dollar}R(String value) {
        RegexResult result = RegexResult.instance();
        Matcher matcher = RegexDefine.${symbol_dollar}R_REGEX_PATTERN.matcher(value);
        if (matcher.matches()) {
            result.setMatched(true);
            result.setRegex(RegexDefine.${symbol_dollar}R_REGEX);
            result.setPattern(RegexDefine.${symbol_dollar}R_REGEX_PATTERN);
     ...
     * 示例2：部分匹配的正则表达式定义.
     *
     * <p>创建时间: <font style="color:${symbol_pound}00FFFF">20180424 15:09</font><br>
     * [请在此输入功能详述]
     *
     * @param value - 格式化的日志
     * @return com.ishanshan.regex.RegexResult 解析结果
