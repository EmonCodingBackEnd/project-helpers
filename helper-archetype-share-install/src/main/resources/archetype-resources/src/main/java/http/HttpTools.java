...
import ${package}.http.client.HttpSyncClient;
import ${package}.http.property.HttpMethod;
import ${package}.http.support.ClientSupport;
import ${package}.http.support.HeaderSupport;
 ...
 * Http工具.
 *
 * <p>创建时间: <font style="color:${symbol_pound}00FFFF">20180607 12:07</font><br>
 * [请在此输入功能详述]
 *
 * @author Rushing0711
 * @version 1.0.0
