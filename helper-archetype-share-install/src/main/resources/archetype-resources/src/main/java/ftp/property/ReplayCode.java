 ...
 * FTP状态码列表.
 *
 * <p>创建时间: <font style="color:${symbol_pound}00FFFF">20180626 16:39</font><br>
 * [请在此输入功能详述]
 *
 * @author Rushing0711
 * @version 1.0.0
...
public enum ReplayCode {
    ...
    PATHNAME_CREATED(FTPReply.PATHNAME_CREATED, "创建${symbol_escape}"PATHNAME${symbol_escape}""),
