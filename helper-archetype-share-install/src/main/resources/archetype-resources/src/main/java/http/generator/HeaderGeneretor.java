...
import ${package}.http.property.HttpRequestHeader;
 ...
 * Http请求头Header生成器.
 *
 * <p>创建时间: <font style="color:${symbol_pound}00FFFF">20180608 12:17</font><br>
 * [请在此输入功能详述]
 *
 * @author Rushing0711
 * @version 1.0.0
...
public class HeaderGeneretor {
     ...
     *
     * @param cookie - 例如：Cookie: ${symbol_dollar}Version=1; Skin=new;
     * @return -
     */
