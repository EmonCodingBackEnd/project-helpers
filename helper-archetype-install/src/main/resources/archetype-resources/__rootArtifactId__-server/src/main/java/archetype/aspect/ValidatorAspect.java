 ...
 ********************************************************************************/
package ${package}.archetype.aspect;

import ${package}.archetype.exception.AppStatus;
import ${package}s.tool.cmp.api.AppRequest;
import ${package}s.tool.cmp.exception.AppException;
...
public class ValidatorAspect {
    ...
    @Pointcut("execution(* ${package}.archetype.service..*.*(..))")
